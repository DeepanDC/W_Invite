...
const AnimatedFloralBackground = ({ direction }) => (React.createElement("div", { className: "petals-container" }, Array.from({ length: 10 }).map((_, i) => (React.createElement(HeartIcon, { key: i, className: `petal ${direction === 'up' ? 'petal-bottom' : 'petal-top'}` })))));
